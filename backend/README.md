...
## Project Structure
    ...
    ├── testapiautoteammemb_74984  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_74984`
...
2. Clone this repo and `cd testapiautoteammemb_74984`
